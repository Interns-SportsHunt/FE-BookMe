        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/venue-filter" className="text-gray-400 hover:text-white transition">Find Venues</Link></li>
              <li><Link to="/host/create-venue" className="text-gray-400 hover:text-white transition">List Your Venue</Link></li>
            </ul>
          </div>
